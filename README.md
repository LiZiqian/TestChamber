...
`start_server.bat` 会先询问是否使用默认端口 `9398`；如果选择 `N`，请输入 `1024-49151` 范围内的端口，并尽量避开 `3000`、`3306`、`5000`、`5432`、`6379`、`8000`、`8080`、`8888`、`9000` 等常见端口。
...
如果启动脚本自动找不到 Python，会提示输入或拖入 `python.exe` 的完整路径；也可以输入包含 `python.exe` 的目录。
