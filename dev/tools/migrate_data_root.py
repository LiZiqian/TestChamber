#!/usr/bin/env python3
"""Migrate legacy TestChamber runtime data into the project data root.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Migrate TestChamber data to the project data root")
    parser.add_argument("--platform-root", default=str(ROOT), help="Platform source directory, default: repository root")
    parser.add_argument("--data-dir", default=None, help="Target data directory, default: project data/")
